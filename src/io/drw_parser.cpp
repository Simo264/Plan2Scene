...
{  
  ...
  if(layer_type == LayerType::DOOR)
  {
    ...
    // Compute the chord: a single segment from arc start to arc end
    auto p1 = glm::dvec2{
    ...
    door_segments.push_back(Segment{ p1, p2, layer_type });
  }
}
